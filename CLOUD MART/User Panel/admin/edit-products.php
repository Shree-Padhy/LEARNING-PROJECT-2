...
mysqli_stmt_bind_param($stmt, 'iisssssssi', $category, $subcat, $productname, $productcompany, $productprice, $productdescription, $productscharge, $productavailability, $productpricebd, $pid);

if (mysqli_stmt_execute($stmt)) {
    $_SESSION['msg'] = "Product Updated Successfully !!";
} else {
    $_SESSION['error'] = "Error updating product: " . mysqli_error($con);
}

mysqli_stmt_close($stmt);
mysqli_close($con);

header('Location: manage-products.php'); // Replace 'your_page.php' with the appropriate redirect URL
exit();
